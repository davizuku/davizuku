<div id="header">
    <h1 align="center">David Álvarez Pons</h1>
    <h3 align="center">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&width=435&lines=Doing+good+is+part+of+our+code;Software+Engineer+%26+Data+Scientist" alt="Typing SVG">
    </h3>
</div>
<div id="contact-badges">
    <p align="center">
        <a href="https://linkedin.com/in/david-alvarez-pons" target="_blank">
            <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"></a>&nbsp;
        <a href="https://www.interviewbit.com/profile/davizuku" target="_blank">
...
<div id="about-me">
    <h3>👋 About me</h3>
    <ul>
        <li>Extensive experience in software engineering (13+ years)</li>
        <li>Broad and deep vision in architecture and code data structures & algorithms</li>
        <li>Efficient, scalable, and sustainable systems design</li>
        <li>Data science and predictive ML models for data-driven decisions</li>
        ...
        <td width="50%" align="center">
            ...
            <p align="center">
                <a href="https://github.com/davizuku/bcn.gps.art" target="blank" title="Go to source">
                    <img height="100px" src="https://github.com/davizuku/bcn.gps.art/blob/main/assets/img/icon.png?raw=true" alt="bcn.gps.art-icon"/> 
                </a>
            </p>
            <p align="center">
                <a href="https://github.com/davizuku/bcn.gps.art" target="blank" title="Go to source">
...
<div id="education">
    ...
    <ul>
        ...
        <li><a href="https://github.com/davizuku/tensorflow-udemy">tensorflow-udemy</a> </li>
        <li><a href="https://github.com/davizuku/udemy-elasticsearch">udemy-elasticsearch</a> </li>
        <li><a href="https://github.com/davizuku/skillshare-nodejs">skillshare-nodejs</a> </li>
        <li><a href="https://github.com/davizuku/react-nextjs-tutorial">react-nextjs-tutorial</a> </li>
        <li><a href="https://github.com/davizuku/go-microservices">go-microservices</a> </li>
    </ul>
</div>
<div id="tech-platform">
    <h3> 👨‍💻 Tech / Platform </h3>
    <h4> 🔡 Programming Languages </h4>
    <p align="left">
        <img src="https://skillicons.dev/icons?i=php,python,js,nodejs,typescript,regex,bash,cpp,java,go,html,css,r" />
    </p>
    <h4> 📐 Frameworks </h4>
    <p align="left">
    ...
    <p align="left">
        <img src="https://skillicons.dev/icons?i=docker,mysql,aws,vercel,postgres,mongodb,graphql" />
    </p>
    <h4> 🧰 Tooling </h4>
    <p align="left">
